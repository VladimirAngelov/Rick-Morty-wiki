...
function EpisodeDetails({episode}) {
    ...
    return (
        <>
            <Navigation/>
            <div style={{marginLeft: '7vw', fontSize: '2vw'}}><i>Episode:</i> <strong>{episodeData.name}</strong></div>
            <div style={{marginLeft: '7vw', fontSize: '1.5rem', marginTop: '2vh'}} ><i>Released Date:</i> <strong>{episodeData.air_date}</strong></div>
